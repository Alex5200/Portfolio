...
export default function SteckTech(){
    return(
    <div className="flex  flex-col items-center justify-center mt-10">
        <h1 className="font-bold text-4xl mb-6 text-black/70">My steck</h1>
        <div className=" flex gap-4 mt-4  flex-wrap items-center justify-center">
            ...
            className=" border border-2 p-4 rounded-md flex gap-2 border-orange-600 text-black/70 font-semibold text-center ">
                HTML5
            ...
            initial={{opacity: 0, y:-25}}
            whileHover={{ scale: 1.2 }}
            className=" border border-2 p-4 rounded-md border-green-300 text-black/70 font-semibold">
                CSS3
            </motion.div>
            <motion.div

            whileHover={{ scale: 1.2 }}
            className="flex flex-wrap mx-6 gap-4 justify-center items-center">
                <motion.div
                ...
                className="flex">
                    ...
                    <div className=" border p-4 rounded-md border-2 border-blue-400 bg-white flex gap-2 text-black/70 font-semibold">
                        React
                        <svg width={20} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                initial={{opacity: 0, x:-25}}
                className="flex">
                    <div className=" border p-4 rounded-md border-2 border-green-400 bg-white flex gap-2 text-black/70 font-semibold">
                        MobX
                    </div>
                    <svg width={60} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 12H18M12 6V18" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                initial={{opacity: 0, x:25}}
                className="flex">
                    <div className=" border p-4 rounded-md border-2 border-[#764abc] bg-white flex gap-2 text-black/70 font-semibold">
                        Redux
                    </div>
                    <svg width={60} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 12H18M12 6V18" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                initial={{opacity: 0, x:25}}
                className="flex">
                    <div className=" border p-4 rounded-md border-2 border-[#ffb516] bg-white flex gap-2 text-black/70 font-semibold">
                        Eartho
                    </div>
                    <svg width={60} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 12H18M12 6V18" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                initial={{opacity: 0, x:25}}
                className="flex">
                    <div className=" border p-4 rounded-md border-2 border-[#ffffff] bg-white flex gap-2 text-black/70 font-semibold">
                        ...
                    </div>
                    <svg width={60} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
